...
public class ProductAPITestWithJsonPath extends BaseTest {
	...
	public void getProductTest() {
		...
		List<Map<String, Object>> idTitleCatList = JsonPathValidatorUtil.readListOfMaps(response,
				"$.[*].['id', 'title', 'category']");
		System.out.println(idTitleCatList);

		List<Map<String, Object>> jewlIDTitleList = JsonPathValidatorUtil.readListOfMaps(response,
